...
const main = async (): Promise<void> => {
    ...
    try {
        ...
        await writeFile(
            ...
            [
                "import { addEncryptedValues, decryptAdditive, encryptAdditive, generateParameters, getGroup } from 'threshold-elgamal';",
                "import { fixedBaseModPow, resetBigintMathBackend, setBigintMathBackend } from 'threshold-elgamal/core';",
                "import { createGjkrState } from 'threshold-elgamal/dkg';",
                "import { hashProtocolPhaseSnapshot } from 'threshold-elgamal/protocol';",
                '',
                "const groupName = 'ffdhe2048';",
                ...
                '}',
                'if (fixedBaseModPow(group.g, 2n, group.p) !== (group.g * group.g) % group.p) {',
                "  throw new Error('Packed core import failed fixed-base exponentiation');",
                '}',
