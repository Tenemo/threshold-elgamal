...
[InvalidGroupElementError](../../core/classes/InvalidGroupElementError.md) When `ciphertext` is not valid for
the selected group.

## Throws

[PlaintextDomainError](../../core/classes/PlaintextDomainError.md) When the decrypted plaintext lies
