...
const completedScenarios: readonly (VotingFlowScenario & {
    ...
    {
        name: 'completes a 3-of-3 unanimous maximum tally',
        participantCount: 3,
        threshold: 3,
        votes: [10n, 10n, 10n],
    ...
    {
        name: 'completes a 1-of-3 single-share recovery flow',
        participantCount: 3,
        threshold: 1,
        votes: [2n, 5n, 8n],
        decryptionParticipantIndices: [2],
        expectedQual: [1, 2, 3],
    },
    {
    ...
    {
        name: 'completes a 4-of-5 abstention-aware flow',
        participantCount: 5,
        threshold: 4,
        votes: [0n, 10n, 0n, 10n, 10n],
        allowAbstention: true,
        decryptionParticipantIndices: [2, 3, 4, 5],
        expectedQual: [1, 2, 3, 4, 5],
    },
    {
