...
[threshold-elgamal](../../modules/) / [threshold-elgamal](../) / encryptAdditive

# Function: encryptAdditive()

> **encryptAdditive**(`message`, `publicKey`, `group`, `bound`): [`ElgamalCiphertext`](../type-aliases/ElgamalCiphertext/)
